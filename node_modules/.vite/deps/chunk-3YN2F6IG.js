...
} from "./chunk-V2XEYQNM.js";
import {
  ConfigContext,
  LayoutContext
} from "./chunk-67C4GL7F.js";
import {
  _objectSpread2,
  require_classnames
} from "./chunk-ARHRFDWI.js";
import {
  __toESM,
  require_react
...
var Sider = React.forwardRef((_a, ref) => {
  var {
    ...
    onCollapse,
    onBreakpoint
  } = _a, props = __rest(_a, ["prefixCls", "className", "trigger", "children", "defaultCollapsed", "theme", "style", "collapsible", "reverseArrow", "width", "collapsedWidth", "zeroWidthTriggerStyle", "breakpoint", "onCollapse", "onBreakpoint"]);
  const {
    siderHook
  ...
  const renderSider = () => {
    ...
    }, trigger || React.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React.createElement(RightOutlined_default, null) : React.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React.createElement(LeftOutlined_default, null) : React.createElement(RightOutlined_default, null)
    };
...
//# sourceMappingURL=chunk-3YN2F6IG.js.map
